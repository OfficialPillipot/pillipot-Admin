...
export const endpoints = {
  ...
  vendorPortalOrderUpdateStatus: (id: string) => `${V1}/vendor-portal/orders/${id}/status`,
  vendorPortalCategories: `${V1}/vendor-portal/categories`,
